...
<body>
    <div class="sidenav text-center">
        <div class="side_top">
            ...
            <h1 class="top_hd mt-2"><a href="index.html">Kürşad Demir</a></h1>
            <p class="top_hdp mt-2">Developer</p>
        </div>
        <!-- header -->
        <header>
            <div class="nav-top">
                <nav class="mnu mx-auto">
                    ...
                    <ul class="menu">
                        ...
                        <li class="mt-sm-3"><a href="#about" class="scroll">Eğtiim Hayatım</a></li>
    ...
    <div class="main">
        ...
        <section class="slide-wrapper" id="about">
            <h2 class="w3_head mb-4">Eğtiim Hayatım</h2>
